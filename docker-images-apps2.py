...
images = [
    'elysiannxt/ifrs9-measurement-calculation-loader:11.0.0',
    'elysiannxt/ifrs9-impairment-calculation-loader:11.0.0',
    'elysiannxt/historical-pd-calculation-loader:11.0.0',
    'elysiannxt/historical-lgd-calculation-loader:11.0.0',
    'elysiannxt/recovery-analysis-calculation-loader:11.0.0',
    'elysiannxt/titanium-transformer:11.0.1',
    'elysiannxt/stage-assessor:11.0.0',
    'elysiannxt/cashflow-generator:11.0.0',
    'elysiannxt/level-assessor:11.0.0'
]
